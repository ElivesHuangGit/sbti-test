// SBTI 15个维度定义 - 5大模型 x 3维度
// 每个维度有 L(低)/M(中)/H(高) 三个等级描述

export const models = {
  S: { cn: '自我模型', dimensions: ['S1', 'S2', 'S3'] },
  E: { cn: '情感模型', dimensions: ['E1', 'E2', 'E3'] },
  A: { cn: '态度模型', dimensions: ['A1', 'A2', 'A3'] },
  Ac: { cn: '行动驱力模型', dimensions: ['Ac1', 'Ac2', 'Ac3'] },
  So: { cn: '社交模型', dimensions: ['So1', 'So2', 'So3'] }
}
